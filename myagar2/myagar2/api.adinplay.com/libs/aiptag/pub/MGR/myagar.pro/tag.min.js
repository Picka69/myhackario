...
aiptag.settings = {
	...
	sPubName: 'MGR',
	sPubUrl: 'myagar.pro',
	sAdUnitVideo: 'myagar.pro_preroll',
	sRewardedAdUnitVideo: '',
	sRewardAdUnitVideoFallback: '',
	iRefreshDisplay: 60000,
...
function aipAPI() {
	...
	if(aiptag.settings.iVideoAdUnitBidders) {
		this.videoAdUnit = [];
		this.videoAdUnit["myagar.pro_preroll"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
bids: [
	{
		...
		params: {
			...
			this.adUnits['myagar-pro_300x250'] = [{
		code: 'myagar-pro_300x250',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: {
					placementId: '15599611'
				}
			}
		]
	}];
		this.adSlots['myagar-pro_300x250'] = {adunit: 'myagar.pro_300x250', sizes: [300, 250], reload: true, autoRefresh: false};
				this.requestManager['myagar-pro_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['myagar-pro_728x90'] = [{
		code: 'myagar-pro_728x90',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: {
					placementId: '20674695'
				}
			}
		]
	}];
		this.adSlots['myagar-pro_728x90'] = {adunit: 'myagar.pro_728x90', sizes: [728, 90], reload: true, autoRefresh: false};
				this.requestManager['myagar-pro_728x90'] = {adserverRequestSent: false, aps: false, prebid: false};
...
timeout:8E3,allowAuctionWithoutConsent:!0,defaultGdprScope:!0}}});aipAPItag.CMPloadTimeout=setTimeout(function(){aipAPItag.log("AIP Ads started after CMP timeout");aipAPItag.start()},aipAPItag.timeout_cmp);var e=document.createElement("link");e.type="text/css";e.rel="stylesheet";e.async=!0;e.href="https://cdn.consentmanager.mgr.consensu.org/delivery/cmp.min.css";document.getElementsByTagName("head")[0].appendChild(e);window.cmp_id="bottom"===aiptag.cmp.position?15920:13566;window.gdprAppliesGlobally=
!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_host="consentmanager.mgr.consensu.org";window.cmp_cdn="cdn.consentmanager.mgr.consensu.org";(function(){var f="",n="_en";"cmp_getlang"in window&&(f=window.cmp_getlang().toLowerCase(),n="_"+f);var l=document.createElement("script");l.src="https://"+window.cmp_host+"/delivery/cmp.php?id="+window.cmp_id+"&h="+encodeURIComponent(location.href)+"&"+window.cmp_params+(0<document.cookie.length?"&__cmpfcc=1":"")+"&l="+f+"&o="+(new Date).getTime();
l.type="text/javascript";l.setAttribute("data-cmp-ab","1");l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):document.write(l.outerHTML);l=document.createElement("script");l.src="https://"+window.cmp_cdn+"/delivery/cmp"+n+".min.js";l.type="text/javascript";l.setAttribute("data-cmp-ab","1");l.async=!0;document.body?document.body.appendChild(l):document.currentScript?document.currentScript.parentElement.appendChild(l):document.write(l.outerHTML);
window.cmp_addFrame=function(g){if(!window.frames[g])if(document.body){var m=document.createElement("iframe");m.style.cssText="display:none";m.name=g;document.body.appendChild(m)}else window.setTimeout('window.cmp_addFrame("'+g+'")',10)};window.cmp_rc=function(g){for(var m=document.cookie,q="",t=0;""!=m&&100>t;){for(t++;" "==m.substr(0,1);)m=m.substr(1,m.length);var v=m.substring(0,m.indexOf("=")),x=-1!=m.indexOf(";")?m.substring(m.indexOf("=")+1,m.indexOf(";")):m.substr(m.indexOf("=")+1,m.length);
g==v&&(q=x);v=m.indexOf(";")+1;0==v&&(v=m.length);m=m.substring(v,m.length)}return q};window.cmp_stub=function(){var g=arguments;__cmapi.a=__cmapi.a||[];if(g.length)if("ping"===g[0])if(2===g[1])g[2]({gdprApplies:gdprAppliesGlobally,cmpLoaded:!1,cmpStatus:"stub",displayStatus:"hidden",apiVersion:"2.0",cmpId:31},!0);else g[2]({gdprAppliesGlobally:gdprAppliesGlobally,cmpLoaded:!1},!0);else if("getUSPData"===g[0])g[2]({version:1,uspString:window.cmp_rc("")},!0);else if("getTCData"===g[0])__cmapi.a.push([].slice.apply(g));
else if("addEventListener"===g[0])__cmapi.a.push([].slice.apply(g));else if(4==g.length&&!1===g[3])g[2]({},!1);else __cmapi.a.push([].slice.apply(g));else return __cmapi.a};window.cmp_msghandler=function(g){var m="string"===typeof g.data;try{var q=m?JSON.parse(g.data):g.data}catch(v){q=null}if("object"===typeof q&&null!==q&&"__cmpCall"in q){var t=q.__cmpCall;window.__cmp(t.command,t.parameter,function(v,x){var w={__cmpReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):
w,"*")})}"object"===typeof q&&null!==q&&"__cmapiCall"in q&&(t=q.__cmapiCall,window.__cmapi(t.command,t.parameter,function(v,x){var w={__cmapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")}));"object"===typeof q&&null!==q&&"__uspapiCall"in q&&(t=q.__uspapiCall,window.__uspapi(t.command,t.version,function(v,x){var w={__uspapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")}));"object"===typeof q&&null!==
q&&"__tcfapiCall"in q&&(t=q.__tcfapiCall,window.__tcfapi(t.command,t.version,function(v,x){var w={__tcfapiReturn:{returnValue:v,success:x,callId:t.callId}};g.source.postMessage(m?JSON.stringify(w):w,"*")},t.parameter))};window.cmp_setStub=function(g){g in window&&("function"===typeof window[g]||"object"===typeof window[g]||"undefined"!==typeof window[g]&&null===window[g])||(window[g]=window.cmp_stub,window[g].msgHandler=window.cmp_msghandler,window.addEventListener?window.addEventListener("message",
window.cmp_msghandler,!1):window.attachEvent("onmessage",window.cmp_msghandler))};window.cmp_addFrame("__cmapiLocator");window.cmp_addFrame("__cmpLocator");window.cmp_addFrame("__uspapiLocator");window.cmp_addFrame("__tcfapiLocator");window.cmp_setStub("__cmapi");window.cmp_setStub("__cmp");window.cmp_setStub("__tcfapi");window.cmp_setStub("__uspapi")})();__cmp("addEventListener",["consent",function(f,n){aipAPItag.log("AIP Ads started after consent");aipAPItag.start();var l="Privacy settings";aiptag.cmp.buttonText&&
...
null);__cmp("addEventListener",["init",function(f,n){try{var l=new CustomEvent("aip_consentinit",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["settings",function(f,n){try{clearTimeout(aipAPItag.CMPloadTimeout)}catch(g){}try{var l=new CustomEvent("aip_consentsettings",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["consentscreen",function(f,n){try{var l=new CustomEvent("aip_consentscreen",
{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["consentscreenoff",function(f,n){try{var l=new CustomEvent("aip_consentscreenoff",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null);__cmp("addEventListener",["liestablished",function(f,n){try{var l=new CustomEvent("aip_consentliestablished",{detail:{eventname:f,cmpobject:n}});document.dispatchEvent(l)}catch(g){}},!1],null)}if(!0===aiptag.cmp.show)if(aipAPItag.log("aiptag.cmp.show = true"),
"true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),b();else if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, GDPR Consent not required"),c();else{var d=new XMLHttpRequest;d.onreadystatechange=function(){if(d.readyState==XMLHttpRequest.DONE)if(200==d.status){var e="";try{e=d.responseText.toUpperCase()}catch(f){}a("CountryCode",e,"7889229");aipAPItag.CountryCode=e;0<="AT AX BE BG CY CZ DE DK EE EL ES EU FI FR GB GF GI GP GR HR HU IE IS IT LI LT LU LV ME MF MQ MT NL NO PL PT RE RO SE SI SK YT UK".split(" ").indexOf(e)?
...
a.slot.getSlotElementId());aipAPItag.log(a)}catch(b){}})})),aiptag.settings.sAdUnitVideo||aiptag.settings.sRewardedAdUnitVideo)aiptag.settings.sRewardedAdUnitVideo&&!aiptag.settings.sAdUnitVideo?aipAPItag.initPlayerTag():aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//imasdk.googleapis.com/js/sdkloader/ima3.js",function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)})}else aipAPItag.log("Ads already started")};function aipDisplay(){}
...
aipDisplay.prototype.refresh=function(a){aiptag.cmd.queue.push(aipDisplayTag.wrapFunction(aipDisplayTag.refreshTag,this,[a]));aipDisplayTag.nextQueue()};aipDisplay.prototype.autoRefresh=function(a){!0===aipAPItag.adUnitsAutoRefreshAllowed[a]&&90<=aipAPItag.adUnitsPercentage[a]&&(aipAPItag.adUnitsAutoRefreshAllowed[a]=!1,aipAPItag.log("AD auto refresh: "+a),aipDisplayTag.refresh(a))};
...
" ad request marked with Limited ads status LTD=1")});aiptag.settings.iChildSafeAds&&googletag.cmd.push(function(){googletag.pubads().setPrivacySettings({childDirectedTreatment:!0});aipAPItag.log("COPPA: "+a+" ad request marked with a child-directed status tfcd=1")});if(aipAPItag.inIframe()){aipAPItag.log("iframe display AD, GS=Yes");googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","Yes")});try{aipAPItag.adUnits[a][0].bids.forEach(function(b,d,e){"gumgum"===b.bidder&&e.splice(d,
1)})}catch(b){}}else aipAPItag.log("none iframe display Ad, GS=No"),googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","No")});aiptag.subid&&(aipAPItag.log("Custom SubID"),googletag.cmd.push(function(){googletag.pubads().setTargeting("subid",aiptag.subid)}));googletag.cmd.push(function(){try{var b=aipAPItag.adUnitsRefreshed[a].toString();googletag.pubads().setTargeting("FC",b);aipAPItag.log(a+", FC="+b)}catch(d){}});var c="Other";try{/(cros)/.test(window.navigator.userAgent.toLowerCase())&&
(c="ChromeOS")}catch(b){}googletag.cmd.push(function(){googletag.pubads().setTargeting("OS",c);aipAPItag.log("OS="+c)});aipAPItag.log("AD SLOT DISPLAY: "+a+" - "+aipAPItag.adUnitsRefreshed[a]);aipAPItag.queue_ready_display=!1;aip_pbjs.que.push(function(){aipAPItag.adUnitsLoaded[a]||(aipAPItag.adUnitsLoaded[a]="loaded",googletag.cmd.push(function(){aipAPItag.adSlot[a]=googletag.defineSlot("/"+aiptag.settings.sNetworkIdDisplay+"/"+aipAPItag.adSlots[a].adunit,aipAPItag.adSlots[a].sizes,a).addService(googletag.pubads());
googletag.enableServices();googletag.display(a)}));aipDisplayTag.unsetReload(a);setTimeout(aipDisplayTag.setReload.bind(null,a),aipAPItag.timeout_reload_display);aipDisplayTag.displaySetup(a);var b=aipAPItag.timeout_bid_display;aipAPItag.log("AD REQUEST: "+a);aipAPItag.requestManager[a].adserverRequestSent=!1;aipAPItag.requestManager[a].prebid=!1;aipAPItag.requestManager[a].aps=!1;window.setTimeout(function(){aipDisplayTag.sendAdserverRequest(a)},b);aip_pbjs.requestBids({timeout:b,adUnits:aipAPItag.adUnits[a],
adUnitCodes:[a],bidsBackHandler:function(d){try{aipAPItag.log("Targeting params:"),aipAPItag.log(aip_pbjs.getAdserverTargeting()),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(aip_pbjs.getBidResponses()))}catch(e){}googletag.cmd.push(function(){aiptag.settings.iShowAdblockAdsDisplay&&aipAPItag.gptBlocked?(aipDisplayTag.blocked(a),aipAPItag.queue_ready_display=!0,aipDisplayTag.nextQueue()):(aip_pbjs.setTargetingForGPTAsync([a]),aipAPItag.requestManager[a].prebid=!0,aipDisplayTag.biddersBack(a),
aipAPItag.log("prebid biddersBack - "+a))})}});aiptag.settings.iAmazonAds&&apstag.fetchBids({slots:aipAPItag.adUnitsAps[a],timeout:b},function(d){googletag.cmd.push(function(){apstag.setDisplayBids();aipAPItag.requestManager[a].aps=!0;aipAPItag.log("aps biddersBack - "+a);aipDisplayTag.biddersBack(a)})})})}else aipAPItag.log("AD REFRESH called to soon for: "+a),aipDisplayTag.nextQueue()};
...
!0;aipDisplayTag.autoRefresh(a)},aiptag.settings.iRefreshDisplay)))};
...
"%3D"+a[b]}).join("%26");if(c)try{this.aipConfig.AD_TAG=aipAPItag.urlParamUpdate(this.aipConfig.AD_TAG,"cust_params",c,!0)}catch(b){}this.prepareAd()};
